...
const TrialBanner = ({ appUrl, trialDays }) => (
  <div className="trial-banner">
    ...
    <a href="contact.html" className="trial-banner__cta">
        ...
        {tiers.map((plan, ti) => {
          ...
          return (
            <div key={plan.id || ti} className={"pricing-card gsap-scale-in" + (plan.highlight ? ' pricing-card--featured' : '')}>
              ...
              <a href="contact.html" className={"btn btn-lg" + (plan.highlight ? ' btn-primary' : ' btn-ghost')}>
  ...
  <section className="section bg-subtle">
    <div className="container">
      <div className="section__header gsap-fade-up">
        <span className="eyebrow">What's in each plan</span>
      ...
      <div className="feature-grid">
        {[
          ...
          { icon: <IconConcierge size={24} />, title: 'Clash detection (Pro)', body: 'BVH narrow-phase engine -- same algorithm class as Navisworks. Runs in the browser. Over-reports 2-5x in MVP, same as any automated clash tool, but it catches coordination conflicts before the crew is on site.' },
          { icon: <IconProjects size={24} />, title: 'Mason AI (all plans)', body: 'Core gets 60 queries per project per month. Pro gets unlimited. Same model on both -- drafts RFIs, summarizes issues, flags schedule risks. It\'s on every screen.' },
          { icon: <IconSchedule size={24} />, title: 'AIA pay applications (all plans)', body: 'G702/G703 pay apps built into the billing module. No separate tool, no manual spreadsheet. Change orders flow into the pay app automatically.' },
          ...
          { icon: <IconIssues size={24} />, title: 'Field app (all plans)', body: 'Android app built for offline use. Daily logs, photos, RFIs, and punch items logged on site -- syncs when you get back to signal. Works on $200 job-site tablets.' },
        ].map((item, i) => (
    ...
    <div className="container">
      <div className="split-sect gsap-slide-left">
        <div className="split-copy">
          ...
          <p className="split-copy__body">MASON Pro is $399/month. $4,788 a year. It's not a stripped-down version of that stack -- it runs the same BVH clash detection algorithm Navisworks uses, the same IFC-native BIM viewer, the same Monte Carlo simulation. Built for teams that can't justify a six-figure software bill.</p>
        ...
        <div className="split-visual">
          <div className="pricing-philosophy-card">
            ...
            <div className="pp-card__note">Same BVH clash detection algorithm as Navisworks. Browser-based IFC viewer. Monte Carlo P50/P80/P90. No Autodesk license, no Bluebeam subscription, no per-seat Procore fees.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="cta-band">
    <div className="container cta-band__inner">
      ...
      <div className="cta-band__actions">
        ...
        <a href="contact.html" className="btn btn-ghost btn-lg">Ask a question first</a>
      </div>
    </div>
  </section>
);
