// app.jsx -- Home page body (header/footer from MarketingLayout)

import React, { useEffect, useMemo, useRef } from "react";
import { useSiteContent } from "./cms.jsx";
import { IconArrowRight } from "./icons.jsx";
import { ProductPreview } from "./hero.jsx";
import {
  Pillars,
  ModuleGrid,
  BIMProof,
    ...
    <div className="site">
      <section className="hero mason-glow-zone mason-line-reveal mason-parallax-slow" id="top">
        ...
        <div className="container hero__inner">
          <div className="hero__copy">
            ...
            <p className="lede fade-up" style={{ animationDelay: "220ms" }}>
              {hero.subheadline ||
                "From BIM and schedule to RFIs, issues, and field logs -- MASON brings the office and the jobsite into a single, permission-aware system, with an AI Concierge that knows your project."}
            </p>
        ...
        <div className="hero__expansion container">
          ...
          <span className="hero__expansion-sep" aria-hidden="true">
            /
          </span>
