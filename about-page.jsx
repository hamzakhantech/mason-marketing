  ...
  <section className="page-hero">
    ...
    <div className="container" style={{position:"relative",zIndex:1}}>
      <div className="page-hero__inner">
        <span className="page-hero__eyebrow gsap-fade-up">Our story</span>
        <h1 className="page-hero__title gsap-fade-up">
          We built MASON because<br />
          construction teams <span style={{color:"var(--accent)"}}>deserved better.</span>
        </h1>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:72,alignItems:"center"}} className="about-story-grid">
        ...
        <div className="gsap-slide-right">
          <div style={{background:"var(--bg-elev)",border:"1px solid var(--line)",borderRadius:16,padding:32}}>
            ...
            <a href="pricing.html" className="btn btn-primary" style={{width:"100%",justifyContent:"center",marginTop:8}}>See full pricing</a>
          </div>
        </div>
      </div>
    </div>
