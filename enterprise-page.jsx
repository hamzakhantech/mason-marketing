...
const EntFAQ = () => {
  ...
  const items=[
    {q:"Do you have a formal security questionnaire response?",a:"Yes. We maintain a pre-filled security questionnaire covering our infrastructure, data handling, access controls, and incident response process. We can provide this under NDA during procurement. Contact enterprise@masononsite.com to request it."},
