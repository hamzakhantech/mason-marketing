    ...
    <div className="container">
      ...
      <div className="feature-grid">
        {[
          ...
          { title: "SMTP Email", body: "MASON notifications can route through your corporate email server. Subcontractors and reviewers receive RFI, issue, and submittal notifications from your email domain, not connect@masononsite.com." },
